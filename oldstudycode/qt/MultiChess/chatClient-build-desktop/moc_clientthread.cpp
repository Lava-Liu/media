...
#include "../chatClient/clientthread.h"
...
static const char qt_meta_stringdata_ClientThread[] = {
    "ClientThread\0\0sendSockfd(int)\0"
};
...
int ClientThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sendSockfd((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void ClientThread::sendSockfd(int _t1)
{
